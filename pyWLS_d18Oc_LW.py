# alyssa's code, but I removed the stuff I don't understand / isn't relevant to the plot I'm trying to produce
...
axis[1].plot(sss_final, d18O_plus_SST, 'o', label = 'original data', color='k')
axis[1].plot(sss_final, a4 + b4*sss_final, 'orange', label="δ18Oc + 0.21*SST = {0:.3f}*SSS + {1:.2f}".format(b4, a4))
